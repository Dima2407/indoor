...
-(void)viewWillAppear:(BOOL)animated{
    ...
    if ([[NSUserDefaults standardUserDefaults] boolForKey:kBLENavigationSwitch])
    {
        ...
        else if ([[NSUserDefaults standardUserDefaults] boolForKey:kBLETrilatirationSwitch]){
            filter = @"Trilatiration";
        ...
        [[BeaconManager sharedManager] setBeaconConfig:filter useMap:usemap useMesh:useMask useWalls:useWalls];
    }
