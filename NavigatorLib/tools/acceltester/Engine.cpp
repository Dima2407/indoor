...
//        using namespace std;
        ...
        // Read config
//        Config.readJSON("temp.json", verbose);
...
//        if (!Config.getTrajectory().readAuto(Config.getAccelerometer(), verbose)) return false;
...
//        timeOrigin = Config.getTrajectory().startTime();
