...
@interface OpenGLESViewController () <AVCaptureVideoDataOutputSampleBufferDelegate>
...
// maybe add lock - unlock buffer calls ?..
...
//    if (filteredImage)
        [_ciContext drawImage:sourceImage/*filteredImage*/ inRect:_videoPreviewViewBounds fromRect:drawRect];
